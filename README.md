...
[![LatestPyPIrelease](
    https://img.shields.io/gitlab/pipeline/aedev-group/aedev_project_vars/release0.3.18?logo=python)](
    https://gitlab.com/aedev-group/aedev_project_vars/-/tree/release0.3.18)
